"""
This module implements the core developer interface for waktube.
...
import waktube
import waktube.exceptions as exceptions
from waktube import extract, request
from waktube import Stream, StreamQuery
from waktube.helpers import install_proxy
from waktube.innertube import InnerTube
from waktube.metadata import YouTubeMetadata
...
class YouTube:
    """Core developer interface for waktube."""
    ...
    def __init__(
        ...
        :param func on_complete_callback:
            ...
            complete events.
        :param dict proxies:
            (Optional) A dict mapping protocol to proxy address which will be used by waktube.
    ...
    def __repr__(self):
        return f'<waktube.__main__.YouTube object: videoId={self.video_id}>'
    ...
    def js(self):
        ...
        if waktube.__js_url__ != self.js_url:
            self._js = request.get(self.js_url)
            waktube.__js__ = self._js
            waktube.__js_url__ = self.js_url
        else:
            self._js = waktube.__js__
    ...
    def fmt_streams(self):
        ...
        # https://github.com/waktube/waktube/issues/1054
        try:
    ...
    @property
    def caption_tracks(self) -> List[waktube.Caption]:
        ...
        return [waktube.Caption(track) for track in raw_tracks]

    @property
    def captions(self) -> waktube.CaptionQuery:
        """Interface to query caption tracks.

        :rtype: :class:`CaptionQuery <CaptionQuery>`.
        """
        return waktube.CaptionQuery(self.caption_tracks)
        ...
        try:
            ...
            raise exceptions.PytubeError(
                (
                    ...
                    'Please file a bug report at https://github.com/waktube/waktube'
                )
            )
