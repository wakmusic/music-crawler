"""Various helper functions implemented by waktube."""
import functools
import gzip
import json
import logging
...
from waktube.exceptions import RegexMatchError
...
def setup_logger(level: int = logging.ERROR, log_filename: Optional[str] = None) -> None:
    ...
    # https://github.com/waktube/waktube/issues/163
    logger = logging.getLogger("waktube")
...
def create_mock_html_json(vid_id) -> Dict[str, Any]:
    ...
    # Get the waktube directory in order to navigate to /tests/mocks
