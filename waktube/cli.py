...
from waktube import __version__
from waktube import CaptionQuery, Playlist, Stream, YouTube
from waktube.helpers import safe_filename, setup_logger
...
def _parse_args(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "The list option causes waktube cli to return a list of streams "
