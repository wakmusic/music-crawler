...
from waktube import extract, request, YouTube
from waktube.helpers import cache, DeferredGeneratorList, install_proxy, uniqueify
...
class Playlist(Sequence):
    ...
    def last_updated(self) -> Optional[date]:
        ...
        fact that this value is returned as a string, waktube does a best-effort parsing
